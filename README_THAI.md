...
3. **ระบบกฎเหล็กและการให้คะแนน (Rules & Confidence)**: AI จะดึง 5 อันดับแรก("รายชื่อรหัสมาตรฐาน 5 ตัว ที่ AI คิดว่าตรงกับที่หมอสั่งมากที่สุด (จัดเรียงตามคะแนน))มาผ่าน "กฎเหล็ก" (เช่น ดักจับ Antigen vs Antibody) และติดป้ายความมั่นใจ (AI_Label) ตามเกณฑ์ดังนี้:
